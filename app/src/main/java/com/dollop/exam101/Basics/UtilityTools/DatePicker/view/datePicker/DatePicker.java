package com.dollop.exam101.Basics.UtilityTools.DatePicker.view.datePicker;
...
import com.dollop.exam101.Basics.UtilityTools.DatePicker.factory.DateFactoryListener;
import com.dollop.exam101.Basics.UtilityTools.DatePicker.factory.DatePickerFactory;
import com.dollop.exam101.Basics.UtilityTools.DatePicker.model.DateModel;
import com.dollop.exam101.Basics.UtilityTools.DatePicker.view.WheelView;
...
public class DatePicker extends LinearLayout implements DateFactoryListener {
    ...
    private void notifyDateSelect() {
        ...
        if (dataSelectListener != null)
            dataSelectListener.onDateSelected(date.getDate(), date.getDay(), date.getMonth()+1, date.getYear());
    }
}
